...
pub const ZMQ_MSG_PROPERTY_ROUTING_ID: &[u8; 11] = b"Routing-Id\0";
pub const ZMQ_MSG_PROPERTY_SOCKET_TYPE: &[u8; 12] = b"Socket-Type\0";
pub const ZMQ_MSG_PROPERTY_USER_ID: &[u8; 8] = b"User-Id\0";
pub const ZMQ_MSG_PROPERTY_PEER_ADDRESS: &[u8; 13] = b"Peer-Address\0";
