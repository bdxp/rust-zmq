...
pub const ZMQ_MSG_PROPERTY_ROUTING_ID: &[u8; 11usize] = b"Routing-Id\0";
pub const ZMQ_MSG_PROPERTY_SOCKET_TYPE: &[u8; 12usize] = b"Socket-Type\0";
pub const ZMQ_MSG_PROPERTY_USER_ID: &[u8; 8usize] = b"User-Id\0";
pub const ZMQ_MSG_PROPERTY_PEER_ADDRESS: &[u8; 13usize] = b"Peer-Address\0";
...
fn bindgen_test_layout_zmq_msg_t() {
    const UNINIT: ::std::mem::MaybeUninit<zmq_msg_t> = ::std::mem::MaybeUninit::uninit();
...
fn bindgen_test_layout_zmq_pollitem_t() {
    const UNINIT: ::std::mem::MaybeUninit<zmq_pollitem_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
extern "C" {
    pub fn zmq_msg_set_routing_id(msg: *mut zmq_msg_t, routing_id: u32) -> ::std::os::raw::c_int;
}
extern "C" {
...
fn bindgen_test_layout_zmq_poller_event_t() {
    const UNINIT: ::std::mem::MaybeUninit<zmq_poller_event_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
extern "C" {
    pub fn zmq_poller_destroy(poller_p: *mut *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn zmq_poller_size(poller: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn zmq_socket_monitor_pipes_stats(s: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn zmq_ppoll(
        items_: *mut zmq_pollitem_t,
        nitems_: ::std::os::raw::c_int,
        timeout_: ::std::os::raw::c_long,
        sigmask_: *const ::std::os::raw::c_void,
    ) -> ::std::os::raw::c_int;
}
